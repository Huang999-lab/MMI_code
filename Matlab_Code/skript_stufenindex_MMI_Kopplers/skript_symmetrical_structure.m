%% Exemplary BPM calculation for a rectangular step-index MMI-element/ Distortion at the beginning of the input and output channels 
%% The external material at the beginning of the input and output channels is luft(could be glass?)
...
z = [0:dz:1200e-6];   %  Länge der gesamte z                                                              % Base vector
...
z_coup = [0:dz:L_coup];
rad_coup = 25e-6;
Excitation.gausscoup = sqrt(xg(:,:,1).^2+yg(:,:,1).^2)<=rad_coup;
