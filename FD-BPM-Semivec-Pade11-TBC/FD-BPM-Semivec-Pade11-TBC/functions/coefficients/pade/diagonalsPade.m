function [ diagC,diagN,diagS,diagE,diagW ] = diagonalsPade( beta_0,neff,n,xg,yg,dim_y,dim_xl,dim_yl,grid,gammaBoundaryCondition,POLARIZATION,FIELDCOMPONENT,BC,pb)
